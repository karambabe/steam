...
<body>
	...
	<div class="col-12" style="background-color: #212429; height: 100%;">
		<div class="col-8 mx-auto pt-5">
				...
				<p class="text-light">Укажите имя профиля и другую информацию – например, настоящее имя. Это поможет друзьям найти вас в сообществе Steam.</p>
				<form action="profile.php" method="GET">
					...
					<input type="text" name="gmail" class="w-25 form-control bg-dark text-white">

					<p class="text-white m-0  mt-3">Возраст</p>
					<input type="number" name="age" class="w-25 form-control bg-dark text-white">

					<p class="text-white m-0  mt-5">Измените пароль <?php echo $_GET['passs'] ?></p>
					<input type="password" name="pass" class="w-25 form-control bg-dark text-white">
